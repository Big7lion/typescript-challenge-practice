...
// ver.1
// type Chainable<T = {'foo': number; 'bar': {value: string}; 'name': string}> = {
//   option<P extends keyof T>(key: P, value: T[P]): Chainable<T> & {P: T[P]}
//   get(): T
// }
...
// ver.2 answer
type Chainable<T = {}> = {
  option<P extends string, V>(key: P, value: V): Chainable<T & {[S in P]: V}>
  get(): T
}
